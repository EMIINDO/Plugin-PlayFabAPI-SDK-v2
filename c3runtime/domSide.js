'use strict';
{
    ...
    const HANDLER_CLASS = class ZalancePlayFabDOMHandler extends globalThis.DOMHandler {
        ...
        _OnNavigate(e) {
            ...
            if (type === "back")
                ...
                if (globalThis["cordova"] && globalThis["cordova"]["InAppBrowser"])
        ...
        _OnRequestFullscreen(e) {
            if (this._exportType === "windows-webview2" || this._exportType === "macos-wkwebview") {
                globalThis.RuntimeInterface._SetWrapperIsFullscreenFlag(true);
        ...
        _OnExitFullscreen() {
            if (this._exportType === "windows-webview2" || this._exportType === "macos-wkwebview") {
                globalThis.RuntimeInterface._SetWrapperIsFullscreenFlag(false);
                this._iRuntime._SendWrapperMessage({
                    "type": "set-fullscreen",
                    "fullscreen": false
                })
